		...
		<div class="container position-relative" style="background-image: url({{ asset('assets/images/bgbanner1.png') }}); background-position-y: bottom;">
			<div style="background-image: url({{ asset('assets/images/bgbanner01.png') }}); background-position-y: inherit; background-repeat: no-repeat; background-position-x: right; height: 100%;">
				<div class="sub-container">
					...
					<div class="d-flex">
						<div class="w-50 pe-5">
							<p class="fs-5 text-secondary">Lorem ipsum dolor sit amet consectetur adipisicing elit. Provident consequuntur adipisci reiciendis sed facere necessitatib.</p>
						</div>
						<div class="w-50 ps-5">
							<p class="fs-5 text-secondary">Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia totam culpa sint minima iste d</p>
						</div>
					</div>
