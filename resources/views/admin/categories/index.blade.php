											...
											<tr>
												...
												<td class="">
													<div class="d-flex align-items-center">
														...
														<a role="button" onclick="return confirmBox('Delete items', 'Are you sure you want to delete the selected items?', 'itemTask', ['{{ $category->id }}', 'delete'])"><img src="{{ asset('assets/images/icon-trash.svg') }}" alt=""></a>
													</div>
												</td>
											</tr>
										@endforeach
