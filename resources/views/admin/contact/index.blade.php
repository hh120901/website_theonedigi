											...
											<tr>
												...
												<td class="">
													<div class="d-flex align-items-center">
														<a href="{{ url('/admin/contact/edit/'.$contact->id) }}" class="me-3"><img src="{{ asset('assets/images/icon-eye.svg') }}" alt=""></a>
														<a role="button" onclick="return confirmBox('Delete items', 'Are you sure you want to delete the selected items?', 'itemTask', ['{{ $contact->id }}', 'delete'])"><img src="{{ asset('assets/images/icon-trash.svg') }}" alt=""></a>
													</div>
												</td>
											</tr>
										@endforeach
