											...
											<tr>
												...
												<td>
													@php
														...
														$foundCategory = $blogChild->first(function ($collection) use ($post_category_id) {
												...
												<td class="">
													<div class="d-flex align-items-center">
														<a href="{{ url('/admin/blogs/edit/'.$post->id) }}" class="me-3"><img src="{{ asset('assets/images/icon-eye.svg') }}" alt=""></a>
