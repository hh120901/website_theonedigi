<div class="container h-100 position-relative">
	<div class="d-flex flex-column h-100 pt-5r">
		<div class="d-md-flex flex-wrap flex-lg-nowrap"> 
			...
			<div class="me-135px ms-5">
				<p class="blog-overview">
					...
					Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti dolor dignissimos ratione blanditiis nisi,
				</p>
			</div>
		</div>
		<div class="ms-135px me-135px mb-4">
			<div class="pt-3 d-flex justify-content-between gap-3 flex-wrap flex-md-nowrap">
		...
		<div class="blog-swiper-container pe-3 px-lg-4">
						...
						@foreach ($blogChild as $i => $b_child)
							...
							@if (!empty($child_posts))
								@foreach ($child_posts as $i_cp => $cp)
									<div class="swiper-slide show-post-in-cate position-relative d-flex justify-content-center" data-cate-target="{{ $b_child->alias }}">
										<a href="{{ url('/blogs/'. $b_child->alias .'/'.$cp->id) }}" class="text-decoration-none">
											...
											<div class="post-title mt-3 d-flex align-items-center overflow-hidden">
		...
		{{--<div class="d-none d-md-flex justify-content-between" style="margin-top: -2.5rem">
