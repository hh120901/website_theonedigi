...
<div class="container contact1-container">
			...
			<div class="col-lg-5">
				...
				<form action="" class="custom-form">
					<div class="apply-input-group mb-4">
						...
						<input type="text" id="contact_name" name="contact_name" class="rounded-4 custom-input" placeholder="Optimus" required>
					</div>
					<div class="apply-input-group mb-4">
						<label for="contact_email">
							<h6 class="small fw-bold">Email <span class="text-danger">*</span></h6>
						</label>
						<input type="email" id="contact_email" name="contact_email" class="rounded-4 custom-input" placeholder="abc@gmail.com" required>
					</div>
					<div class="apply-input-group mb-4">
						<label for="contact_phone">
							<h6 class="small fw-bold">Phone Number <span class="text-danger">*</span></h6>
						</label>
						<input type="text" id="contact_phone" name="contact_phone" class="rounded-4 custom-input" placeholder="03 1234 4567" required>
					</div>
					<div class="apply-input-group mb-4">
	...
	<div class="d-flex justify-content-between">
		<a role="button" class="slide-prev-btn ms-5 d-none d-sm-block">
