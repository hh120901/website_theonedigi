			...
			<div class="col-lg-5">
				...
				<form action="send-contact" name="contactForm" id="contact-form" method="POST" enctype="multipart/form-data" class="custom-form">
					...
					<div class="apply-input-group mb-4">
						...
						<textarea class="custom-textarea required" name="contact_message" id="contact_message" rows="7"></textarea>
						<span class="text-danger fw-semibold error-input d-none small">* This field is required!</span>
					</div>
					<button type="button" class="btn btn-outline-red-primary w-100 fw-bold rounded-4 mt-4 py-2 button-submit-contact">
						Send
					</button>
				</form>
			</div>
